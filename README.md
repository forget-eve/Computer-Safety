...
- [x] 在规定谁负责制定这些策略方面，有两个基本的选择：
  > - <span id="DAC">自主访问控制(Discretionary Access Control)</span>：为每个资源定义一个所有者，让所有者规定谁可以访问，这类策略被称为自主的，因为访问控制由所有者来处理
  > - <span id="MAC">强制访问控制(Mandatory Access Control)</span> ： 系统策略规定谁可以访问，这类策略被称为强制的
